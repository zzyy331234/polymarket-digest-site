...
- why_now: Short-term dislocation detected (1h=0.000, 4h=0.078, 24h=0.438).
- do_not_trade_if: Liquidity/exit quality deteriorates materially before action.
...
- Will the Colorado Avalanche win the 2026 NHL Stanley Cup? | cluster=other | regime=mean_revert | why=Relevant within active cluster=other and current regime=mean_revert.
...
## 后验复盘快照
- outcomes: {'flat': 180, 'miss': 5, 'pending': 7, 'hit': 8}
