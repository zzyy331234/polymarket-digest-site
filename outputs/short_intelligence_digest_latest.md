...
- 世界杯主题盘 | 世界杯主题 | 低效拖时间盘
  避开原因: stale_carry_no
  链接（中文导读）: 中文导读：世界杯主题盘
  Link (English source): English source: Will Haiti win the 2026 FIFA World Cup?
  URL: https://polymarket.com/question/will-haiti-win-the-2026-fifa-world-cup
  值得点开的原因: 因为它属于当前少数还留在版面里的高证据线索，值得直接去原盘核对成交和价格位置。
  原始题目: Will Haiti win the 2026 FIFA World Cup?

## 周度偏好
- 倾向保留: 均值回归 | score=-0.4667 | total=9
- 倾向保留: 低效拖时间盘 | score=-0.5 | total=20
- 应继续降权: 世界杯主题 | score=-0.5 | flat=12
- 应继续降权: 美国大选 | score=-0.5 | flat=11
