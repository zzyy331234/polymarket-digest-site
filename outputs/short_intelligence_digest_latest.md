# Polymarket 情报样刊 | 2026-06-11

一句话判断
继续 paper-only，把版面留给少量高证据候选，把 flat-heavy 主题盘挡在主栏之外。

## 今日主线
今天的主线不是扩张出手，而是收缩注意力：主看“暂无足够强的主观察标的”，继续回避 世界杯主题、其他事件 这类 flat-heavy 噪音盘。
...
## 周度偏好
- 倾向保留: 趋势延续 | score=-0.22 | total=5
- 倾向保留: 均值回归 | score=-0.25 | total=12
- 应继续降权: 世界杯主题 | score=-0.275 | flat=4
- 应继续降权: 其他事件 | score=-0.26 | flat=1
