...
- [watch] Will the Buffalo Sabres win the 2026 NHL Stanley Cup? | YES | conf=0.63 | catalyst=trend_follow
- [watch] Will Pete Buttigieg win the 2028 Democratic presidential nomination? | NO | conf=0.66 | catalyst=mean_reversion
- [watch] Will Alexandria Ocasio-Cortez win the 2028 US Presidential Election? | NO | conf=0.66 | catalyst=price_dislocation
...
- Will Alexandria Ocasio-Cortez win the 2028 US Presidential Election? | cluster=us_election | regime=mean_revert | why=Short-term dislocation detected (1h=0.000, 4h=-0.015, 24h=0.165).
...
## 后验复盘快照
- outcomes: {'flat': 179, 'hit': 9, 'pending': 7, 'miss': 5}
