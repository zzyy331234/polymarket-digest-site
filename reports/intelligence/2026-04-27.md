...
- why_now: Short-term dislocation detected (1h=0.000, 4h=0.007, 24h=0.222).
- do_not_trade_if: Liquidity/exit quality deteriorates materially before action.

### 2. Will the Carolina Hurricanes win the 2026 NHL Stanley Cup? [research] 
...
- Will the Tampa Bay Lightning win the 2026 NHL Stanley Cup? | cluster=other | regime=trend | why=Short-term dislocation detected (1h=0.022, 4h=0.039, 24h=0.480).
...
## 后验复盘快照
- outcomes: {'flat': 175, 'miss': 8, 'hit': 10, 'pending': 7}
