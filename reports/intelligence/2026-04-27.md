...
- why_now: Short-term dislocation detected (1h=0.052, 4h=1.613, 24h=0.500).
...
## 观察名单
- Will Josh Shapiro win the 2028 Democratic presidential nomination? | cluster=us_election | regime=trend | why=Short-term dislocation detected (1h=0.000, 4h=0.027, 24h=0.055).
...
- Will Alexandria Ocasio-Cortez win the 2028 US Presidential Election? | cluster=us_election | regime=mean_revert | why=Short-term dislocation detected (1h=0.000, 4h=-0.080, 24h=-0.050).
- Will the Minnesota Wild win the 2026 NHL Stanley Cup? | cluster=other | regime=trend | why=Short-term dislocation detected (1h=0.000, 4h=0.183, 24h=0.155).
...
## 后验复盘快照
- outcomes: {'flat': 176, 'miss': 7, 'hit': 10, 'pending': 7}
